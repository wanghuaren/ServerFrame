...
func FillUserInfo2Proto(pbDat *pbstruct.SCUserInfo, structUserDat *pbstruct.UserTab) {
	pbDat.Nickname = structUserDat.Nickname
	pbDat.Score = structUserDat.UserScore
